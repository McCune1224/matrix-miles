...
void setup() {
  ...
  // dma_display->shiftDriver(mxconfig.driver);
  dma_display->begin();
  // dma_display->shiftDriver();
  dma_display->setBrightness8(255); //0-255
  dma_display->clearScreen();
  dma_display->fillScreen(myWHITE);
  
  // fix the screen with green
  dma_display->fillRect(0, 0, dma_display->width(), dma_display->height(), dma_display->color444(15, 15, 15));
  delay(500);
  ...
  // draw an 'X' in red
  dma_display->drawLine(0, 3, 31, 3, dma_display->color444(15, 15, 15));
  dma_display->drawLine(0, 8, 31, 8, dma_display->color444(15, 15, 15));
  delay(500);
