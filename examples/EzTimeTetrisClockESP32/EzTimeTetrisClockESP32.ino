...
char ssid[] = "JSBPI";     // your network SSID (name)
char password[] = "waveshare0755"; // your network key
...
void setup() {
  ...
  display.setDriverChip(FM6047);//Write the register,Configure the brightness
